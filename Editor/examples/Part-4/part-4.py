...
from PyTib import AntTib, Segment
...
class Main(QtWidgets.QMainWindow):
    ...
    def initToolbar(self):
        ...
        self.newAction = QtWidgets.QAction(QtGui.QIcon("C:\GitHub\Sandbox\Editor\examples\Part-4\images"), "&New", self, triggered=self.new)
        ...
        self.cutwordAction = QtWidgets.QAction(QtGui.QIcon("icons/cut-word.png"),"Cut words",self)
        self.cutwordAction.setStatusTip("Cut words in current text")
        self.cutwordAction.setShortcut("Ctrl+Q")
        # self.cutwordAction.triggered.connect(self.cutWord)
    ...
    def closeEvent(self,event):
        ...
        if self.changesSaved:
            ...
            popup.setText("ཡིག་ཆ་འགྱུར་བ་བཏང་འདུག")
            
            popup.setInformativeText("འགྱུར་བ་ཉར་ཚགས་དགོས་སམ།")
    ...
    def open(self):
        ...
        if self.filename:
            with open(self.filename,"rb") as file:
                self.text.setText(file.read().decode('utf-8'))
    ...
    def save(self):
        ...
        if self.filename:
            ...
            with open(self.filename,"wb") as file:
                file.write(self.text.toHtml().encode('utf-8'))
    ...
    def cut_word(self):
        seg = Segment()
        file = self.text
        cut_text = seg.segment(file, ant_segment=0, unknown=1)
        self.setPlainText(cut_text)
...
if __name__ == "__main__":
    ...
    app.setFont(QFont('noto Sans Tibetan', 10))
